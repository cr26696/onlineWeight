...
"<form action='/wifi'    method='get'><button>configure111Wifi</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Configure WiFi (No scan)</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>Info111</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>Setup111</button></form><br/>\n",//MENU_PARAM
